...
> 原文:[https://hack aday . com/2011/11/20/grid runner-a-custom-part-for-measuring-in-eagle-CAD/](https://hackaday.com/2011/11/20/gridrunner-a-custom-part-for-measuring-in-eagle-cad/)

![](../Images/1a61dd35ab6a51a98177e61933d1046f.png "pcd-gridrunner")
...
我们发现有趣的是，[Koogar]在 PCB 设计之外还使用 Eagle。我们以前曾用它来设计面板的钻孔模板，但他远不止于此。他使用库编辑器重新创建了他的 CNC 机器的部件，他说这些部件很容易对准。从那里，他导出用于安装支架的 CAM 文件。你用 Eagle 做 PCB 设计以外的事情吗？请留言告诉我们。
 ...
 <https://www.youtube.com/embed/zyM7w1vkevs?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent>

</span> <p>[谢谢鲁伯特]</p> </body> </html>