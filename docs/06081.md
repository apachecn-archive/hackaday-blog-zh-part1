...
> 原文:[https://hackaday.com/2010/10/07/automated-chip-burning/](https://hackaday.com/2010/10/07/automated-chip-burning/)

![](../Images/5770e85134652c9128454abdc22a7237.png "robotic-chip-programmer")
...
我们已经报道过[使用 Arduino 作为 AVR 程序员](http://hackaday.com/2009/07/15/avr-isp-programming-via-arduino/)，但是我们自己从来没有实际做过(我们使用 AVR Dragon 程序员)。休息后看看视频，如果你认为实际的编程似乎慢得令人难以置信，请告诉我们。
 ...
 <https://www.youtube.com/embed/MPusu0SkN2w?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent>

</span> <p>[感谢凯尔通过<a href="http://letsmakerobots.com/node/22393" target="_blank">让我们制造机器人</a></p> </body> </html>