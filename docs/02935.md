...
我们像以前一样上传新的设计，但现在时钟除以 65535，LED 每秒切换一次。
 ...
 <https://www.youtube.com/embed/wNfJKHV0ylg?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent>

</span> <p><strong>更进一步</strong> <br/>下次我们将看看分立的 7400 系列逻辑芯片，并在 CPLD 中实现大量这类芯片，以制作高速总线嗅探器和逻辑分析仪。</p> <p><strong>下载:</strong> <a href="http://blog.mahalo.com/hackaday/howto/bitclone.v1.zip" target="_blank"> bitclone.v1.zip </a></p> </body> </html>*