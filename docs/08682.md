...
左边是一匹不同颜色的马。这是一个模仿《哈利·波特》系列中韦斯莱家时钟的[时钟。时钟技巧是相同的，但是 Arduino 使用 GPS 数据和 NOAA 天气信息来设置状态。](http://www.instructables.com/id/Magical-Location-Clock/)
 ...
 <https://www.youtube.com/embed/gpxrngdSTZk?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent>

T3】</span></p> <p>[感谢因弗诺斯和迈克尔]</p> </body> </html>