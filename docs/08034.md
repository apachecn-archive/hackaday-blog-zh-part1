...
> 原文:[https://hackaday.com/2011/07/10/improved-fpga-synth/](https://hackaday.com/2011/07/10/improved-fpga-synth/)

![](../Images/7a89d7d78a5468d6b26044d82e5379b7.png "fpga")
...
[Mich]计划为 PWM 混频器电路构建 PCB，并增加从序列器接收速度数据的能力。他还考虑在构建中添加一个采样器，但是不太确定实现它的最佳方式。如果你对[Mich]有什么想法，请在评论中留给他。查看下面的视频，观看 FPGA synth 播放*爆米花*的演示。
 ...
 <https://www.youtube.com/embed/9F9AvosC6R8?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent>

</span> <p><img style="position:absolute;top:-10000px;" alt=""/></p> <p><img style="position:absolute;top:-10000px;" alt=""/></p> <p><img style="position:absolute;top:-10000px;" alt=""/></p> </body> </html>