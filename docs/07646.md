...
我们在休息后嵌入了一个剪辑，它贯穿了该板的发展过程。[JJ]作为 megaupload 链接分享了 Eagle CAD 文件，但为了您的方便，我们也在休息后镜像了该文件。
 ...
 <https://www.youtube.com/embed/oXpfKqx7Uhc?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent>

T3】</span></p> <p>[ <a href="http://hosted.hackaday.com/Bluetooth%20break-out%20board.zip">下载 zip 存档文件</a></p> <p>[谢谢凯尔]</p> </body> </html>