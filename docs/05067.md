...
> 原文:[https://hack aday . com/2010/03/19/graffiti-machine-sprays-for-you/](https://hackaday.com/2010/03/19/graffiti-machine-sprays-for-you/)

![](../Images/6d5e745419437499e83c80e30c1056d5.png "graffiti-bot")
...
![](../Images/baa27caf4630a8ff3d702f2cb316fa28.png "DSCF0299")

这是罐头盒。在右边，罐子的上方，你可以看到用来启动和停止油漆流动的马达。在左边，你可以看到用来上下移动马车的同步带。它的两端用 C 形夹固定。

![](../Images/4ed62399c2f25889d671600319dd8500.png "DSCF0325")

[Ben]用一个机器螺丝的头压下拨浪鼓的阀门。

![](../Images/a76bb5b4bf9b1adcc9083611fa1518f5.png "DSCF0295")

龙门架的顶部装有电机，用于移动龙门架本身以及罐托架。

![](../Images/9420d6f60146fba7b3f933cffbfcec3b.png "DSCF0301")

完整的门架是一个整体，罐架沿其长度方向移动。你可以看到齿轮用来移动罐子的同步带。

![](../Images/3872d5f263a1ba2e27a8cc4bb2d093d0.png "DSCF0309")

![](../Images/3b9dd766934b95e8c4b6d545c177da36.png "DSCF0313")

上图显示了用于沿顶部和底部水平轨道移动机架的皮带。一根杆沿着门架的长度移动，由一端的步进电机驱动，以移动顶部和底部传送带的齿轮。

![](../Images/24ca1548478031568b09e1540797f164.png "DSCF0323")

此图像显示了用作轨迹的尖括号。这赋予了机器横向可伸缩性。

![](../Images/fd64a580d6c9c09aa4e1d9524bec2a25.png "DSCF0307")
