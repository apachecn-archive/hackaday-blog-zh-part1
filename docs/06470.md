...
事实证明，一个 8 美元的网络摄像头和一个 Ubuntu 盒子并不能构成一个很好的视频设置。但是如果你一定要看演示，这里就是:
 ...
 <https://www.youtube.com/embed/eUNlzNo9tr8?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent>

</span> <h2>在 Twitter 上关注我</h2> <p></p> </body> </html>