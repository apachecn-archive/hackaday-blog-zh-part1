...
> 原文:[https://hack aday . com/2010/02/04/propeller-takes-step-a-sketch-to-a-new-level/](https://hackaday.com/2010/02/04/propeller-takes-step-a-sketch-to-a-new-level/)

![](../Images/14ba04bff5df9c8ecf61afeb1510bd70.png "prop-a-sketch")
...
在休息后的视频中，你可以看到 Etch-a-Sketch 上的绘图有多精确。它安装得很好，但也受益于一些软件对玩具不精确控制的补偿。[Mpark]还包括一个擦除功能，可以将画面上下翻转几次。这不仅用于擦除绘图，还用于隐藏将手写笔移动到起始位置时创建的线条。
 ...
 <https://www.youtube.com/embed/MgyZgqImAHA?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent>
