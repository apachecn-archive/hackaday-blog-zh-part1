...
> 原文:[https://hack aday . com/2012/01/16/Wii-nuncchuck-on-an-80s-computer/](https://hackaday.com/2012/01/16/wii-nunchuck-on-an-80s-computer/)

![](../Images/e48a02cc91583964fb5507d0a5914136.png "MSX")
...
将双截棍插入 MSX 所需要的只是一个分压器，以及计算机和控制器之间的几个上拉电阻。他们从两个按钮、操纵杆和双节棍中的加速度计获得数据，并编写了一个小程序，在屏幕上显示一些精灵来演示这一点。休息之后请继续关注。
 ...
 <https://www.youtube.com/embed/RNiMxM2kduk?version=3&rel=1&showsearch=0&showinfo=1&iv_load_policy=1&fs=1&hl=en-US&autohide=2&wmode=transparent>

</span> <span class="embed-youtube" style="text-align:center; display: block;"><iframe class="youtube-player" width="800" height="480" src="https://www.youtube.com/embed/w0B2zOgL6-U?version=3&amp;rel=1&amp;showsearch=0&amp;showinfo=1&amp;iv_load_policy=1&amp;fs=1&amp;hl=en-US&amp;autohide=2&amp;wmode=transparent" allowfullscreen="true" style="border:0;" sandbox="allow-scripts allow-same-origin allow-popups allow-presentation"/></span> </body> </html>