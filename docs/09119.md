...
> 原文:[https://hack aday . com/2011/11/19/pushing-FPGA-config-files-via-serial-using-cat/](https://hackaday.com/2011/11/19/pushing-fpga-config-files-via-serial-using-cat/)

![](../Images/69296a8537beaea983f3b12ad9e273be.png "xilinx-config-files")
